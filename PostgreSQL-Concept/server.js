...
/* #1 Imports The pg Package */
const pg = require('pg');

/* #2 Tells Your Express app To Automatically Parse Incoming Requests With JSON Payloads */
app.use(express.json());

/* #3 Both Lines Connect To A PostgreSQL Database, But There's A Key Difference Between Them: */

/* Creates A Single Cconnection To The Database.
You Need To Manually Open And Close It Using client.connect() And client.end().
Best For Simple Scripts Or Single Query Tasks >> You're Running A Short Script That Connects To The Database, Does Something, And Then Exits. */
/* Like ... “I’m making one phone call to the database, then hanging up.” */
const client = new pg.Client(process.env.DATABASE_URL);

/* Creates A pool Of Reusable Connections.
Automatically Handles Multiple Requests Efficiently. */
/* Like ... “I have a team of phones ready to take many calls at the same time.” */
